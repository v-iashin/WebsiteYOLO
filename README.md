...
Step 1. writen the website front-end ([v-iashin/v-iashin.github.io](https://github.com/v-iashin/v-iashin.github.io))
Step 2. obtained a domain name ([Freenom](https://freenom.com/) — I wouldn't recommend it though!)
Step 3. rented an instance and reserved an IP for it ([GoogleCloud](https://cloud.google.com/))
Step 4. added DNS entries mapping my domain to the instance IP ([Freenom](https://freenom.com/) again)
Step 5. signed instance-side digital certificates for HTTPs for my domain ([Let's Encrypt](https://letsencrypt.org/))
Step 6. setted up the back-end environment on my instance + detector implementation (THIS repo)
